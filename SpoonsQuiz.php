...
<body>
    <body1>
        ...
        <li>
            ...
            <div>
                <input type="radio" name="question-1-answers" id="question-1-answers-D" value="F" />
                <label for="question-1-answers-F">Virgo</label>
            </div>
            <div>
                <input type="radio" name="question-1-answers" id="question-1-answers-D" value="G" />
                <label for="question-1-answers-G">Libra</label>
            </div>
            <div>
                <input type="radio" name="question-1-answers" id="question-1-answers-D" value="H" />
                <label for="question-1-answers-H">Scorpio</label>
            </div>
            <div>
                <input type="radio" name="question-1-answers" id="question-1-answers-D" value="I" />
                <label for="question-1-answers-I">Sagittarius</label>
            </div>
            <div>
                <input type="radio" name="question-1-answers" id="question-1-answers-D" value="J" />
                <label for="question-1-answers-J">Capricorn</label>
            </div>
            <div>
                <input type="radio" name="question-1-answers" id="question-1-answers-D" value="K" />
                <label for="question-1-answers-K">Aquarius</label>
            </div>
            <div>
                <input type="radio" name="question-1-answers" id="question-1-answers-D" value="L" />
        ...
        <li>
            ...
            <div>
                <input type="radio" name="question-1-answers" id="question-1-answers-A" value="A" />
                <label for="question-1-answers-A">Little Spoon</label>
            </div>
            <div>
                <input type="radio" name="question-1-answers" id="question-1-answers-B" value="B" />
                <label for="question-1-answers-B">Big Spoon</label>
            </div>
            <div>
                <input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" />
                <label for="question-1-answers-C">A little bit of both</label>
            </div>
        ...
        <li>
            ...
            <div>
                ...
                <label for="question-6-answers-E">The suberbs</label>
            </div>
            <div>
        ...
        <br>
        <li>
            <h3>Which of the following is your celeb crush?</h3>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-A" value="A" />
                <label for="question-7-answers-A">Ryan Reynolds</label>
            </div>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-B" value="B" />
                <label for="question-7-answers-B">Adele</label>
            </div>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-C" value="C" />
                <label for="question-7-answers-C">Aquafina</label>
            </div>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-D" value="D" />
                <label for="question-7-answers-D">Iron Man</label>
            </div>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-E" value="E" />
                <label for="question-7-answers-E">Jason Momoa</label>
            </div>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-F" value="F" />
                <label for="question-7-answers-F">Megan Fox</label>
            </div>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-G" value="G" />
                <label for="question-7-answers-G">Zendaya</label>
            </div>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-H" value="H" />
                <label for="question-7-answers-H">Harry Styles</label>
            </div>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-I" value="I" />
                <label for="question-7-answers-I">Timmy Chalamet</label>
            </div>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-J" value="J" />
                <label for="question-7-answers-J">Heath Ledger</label>
            </div>
            <div>
                <input type="radio" name="question-7-answers" id="question-7-answers-K" value="K" />
                <label for="question-7-answers-K">Kylie Jenner</label>
            </div>
        </li>
        <br>
        <li>
            ...
            <div>
                ...
                <label for="question-8-answers-A">Introvert</label>
            </div>
            <div>
                <input type="radio" name="question-8-answers" id="question-8-answers-B" value="B" />
                <label for="question-8-answers-B">Extrovert</label>
            </div>
            <div>
                <input type="radio" name="question-8-answers" id="question-8-answers-C" value="C" />
                <label for="question-8-answers-C">In the middle</label>
            </div>
        </li>
        <br>
        <li>
            ...
            <div>
                ...
                <label for="question-9-answers-A">Chewing with Mouth Open</label>
            </div>
            <div>
                <input type="radio" name="question-9-answers" id="question-9-answers-B" value="B" />
                <label for="question-9-answers-B">Interrupting</label>
            </div>
            <div>
                <input type="radio" name="question-9-answers" id="question-9-answers-C" value="C" />
                <label for="question-9-answers-C">Being late</label>
            </div>
            <div>
                <input type="radio" name="question-9-answers" id="question-9-answers-D" value="D" />
                <label for="question-9-answers-D">Slow walkers</label>
            </div>
            <div>
                <input type="radio" name="question-9-answers" id="question-9-answers-E" value="E" />
                <label for="question-9-answers-E">Micro-Management</label>
            </div>
            <div>
                <input type="radio" name="question-9-answers" id="question-9-answers-F" value="F" />
                <label for="question-9-answers-F">Ignoring personal space</label>
            </div>
        </li>
        <br>
        <li>
            ...
            <div>
                ...
                <label for="question-8-answers-A">Yes</label>
            </div>
            <div>
        ...
        <li>
            ...
            <div>
                ...
                <label for="question-14-answers-A">18-25</label>
            </div>
            <div>
                <input type="radio" name="question-14-answers" id="question-14-answers-B" value="B" />
                <label for="question-14-answers-B">25-35</label>
            </div>
            <div>
                <input type="radio" name="question-14-answers" id="question-14-answers-C" value="C" />
                <label for="question-14-answers-C">35-45</label>
            </div>
            <div>
                <input type="radio" name="question-14-answers" id="question-14-answers-D" value="D" />
                <label for="question-14-answers-D">45-55</label>
            </div>
            <div>
                <input type="radio" name="question-14-answers" id="question-14-answers-E" value="E" />
                <label for="question-14-answers-E">55-65</label>
            </div>
            <div>
                <input type="radio" name="question-14-answers" id="question-14-answers-F" value="F" />
                <label for="question-14-answers-F">65-75</label>
            </div>
            <div>
                <input type="radio" name="question-14-answers" id="question-14-answers-G" value="G" />
                <label for="question-14-answers-G">75-85</label>
            </div>
            <div>
                <input type="radio" name="question-14-answers" id="question-14-answers-H" value="H" />
                <label for="question-14-answers-H">85-95</label>
            </div>
            <div>
                <input type="radio" name="question-14-answers" id="question-14-answers-I" value="I" />
                <label for="question-14-answers-I">95-105</label>
            </div>
            <div>
                <input type="radio" name="question-14-answers" id="question-14-answers-J" value="J" />
