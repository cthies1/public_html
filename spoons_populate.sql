...
insert into user values ("johnsmith@test.com","test","john","smith",20);
insert into user values ("janesmith@test.com","test","jane","smith",21);
insert into user values ("willy@test.com","test","will","smith",30);
insert into user values ("ben@test.com","test","ben","smith",20);
